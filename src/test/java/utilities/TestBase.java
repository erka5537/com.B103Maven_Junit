...
//    TestBase'i abstract yapmamızın sebebi bu sınıfın objesini oluşturmak istemiyorum
//    TestBase testBase = new TestBase(); -> YAPILAMAZ
//    Amacım bu sınıfı extend etmek ve içindeki hazır metodları kullanmak
//    driver objesini oluştur. Driver ya public ya da protected olmalı. Sebebi child class'larda görünür olması.
...
//        Actions actions = new Actions(driver);
    ...
    //Tam sayfa açılan reklamı kapatmak için oluşturulan method. Reklamın açıldığı yerde kapatmak için methodu çağırın.
    public void clickOutside() {
        Actions action = new Actions(driver);
        action.moveByOffset(0, 0).click().build().perform();
    }

    //Sayfanın altından kayan reklamı kapatmak için oluşturulan method. Reklamın açıldığı yerde kapatmak için methodu çağırın.
...
//Chrome'a Adblock uzantısını yükle
        ...
        options.addExtensions(new File("C:\\Users\\ERKA55\\Downloads\\extension_5_3_3_0.crx"));
