...
public class Test_Case_17 extends TestBase{
...
//        WebElement addBasket = driver.findElement(By.xpath("//*[@class=\"single_add_to_cart_button button alt\"]"));
...
//17) Artık kullanıcı, fatura ayrıntıları formundaki ayrıntılarını doldurabilir ve Doğrudan banka havalesi, çek, nakit veya paypal gibi ödeme ağ geçidinde herhangi bir ödemeyi seçebilir.
...
//11) Kullanıcı o Kitabı Menü öğesinde fiyatla görüntüleyebilir.
        ...
        billingsDetailPhone.sendKeys("053615823700", Keys.TAB, Keys.ENTER, "Turkey");
        ...
        townCity.sendKeys(Keys.TAB, Keys.ENTER, "Balıkesir"); //Province *
        ...
        driver.findElement(By.xpath("//input[@id='payment_method_ppec_paypal']")).sendKeys(Keys.SPACE);//kredi karti secenegi
